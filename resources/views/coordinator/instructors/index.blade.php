@extends('layouts.coordinator', ['title' => 'Instructores'])
...
@push('scripts')
<script>
    const BASE_URL = @json(route('coordinator.instructores.index'));
    ...
    function resetForm() {
        ...
        document.getElementById('instructorForm').action = @json(route('coordinator.instructores.store'));
